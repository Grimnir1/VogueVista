...
<div class="container text-white p-5">
            <div class="row g-4">
                <div class="col-md-4">
                    <h5 class="mb-3">Vogue Vista</h5>
                    <p class="text-muted">Your destination for trendy and stylish fashion.</p>
                </div>
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-0 text-muted">&copy; 2024 Vogue Vista. All rights reserved.</p>
                </div>
